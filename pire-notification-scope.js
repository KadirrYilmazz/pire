(function () {
  ...
  // Fix123: bildirim kapsamı ve okundu durumu artık sunucu tarafındaki canonical
  // /api/notifications + RLS katmanında yönetiliyor. Bu dosyada cihaz-local
  // notification read state tutulmaz; yalnızca katalog seçeneklerindeki eski UI
  // tekrarlarını temizleyen uyumluluk katmanı korunur.
