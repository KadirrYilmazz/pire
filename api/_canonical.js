...
async function authenticate(req){
  if(!originAllowed(req))throw Object.assign(new Error("İstek kaynağına izin verilmiyor."),{status:403});
...
module.exports={send,rest,authenticate,asNumber,dateOnly,timeOnly};
